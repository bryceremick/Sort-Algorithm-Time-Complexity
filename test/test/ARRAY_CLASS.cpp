...
{
    cout << "Sorting Arrays["<< SIZE <<"]..." << endl << endl;
    //calculate sort times for the sorted array
    cout << "Sorting the Sorted Arrays[" << SIZE << "]" << endl;
    for(int i = 0; i < 100; i++)
    {
        if (i % 2 == 0)
            cout << "#";
    ...
    //calculate sort times for the sorted array
    cout << "Sorting the Shuffled Arrays[" << SIZE << "]" << endl;
    for (int i = 0; i < 100; i++)
    {
        if (i % 2 == 0)
            cout << "#";
    ...
    cout << "Sorting the Reversed Arrays[" << SIZE << "]" << endl;
    for (int i = 0; i < 100; i++)
    {
        if (i % 2 == 0)
            cout << "#";
    ...
    cout << endl << "Shuffled Insertion Sort Avg: " << reversedInsertionAvg  << " Microseconds" << endl;
    cout << "Shuffled Selection Sort Avg: " << reversedSelectionAvg  << " Microseconds" << endl;
    cout << "Shuffled Bubble Sort Avg: " << reversedBubbleAvg  << " Microseconds" << endl;
    cout << "Shuffled Quick Sort Avg: " << reversedQuickAvg  << " Microseconds" << endl;
    cout << "Shuffled Merge Sort Avg: " << reversedMergeAvg  << " Microseconds" << endl << endl;
    
    
    //calculate sort times for the ten percent array
    cout << "Sorting the Ten Percent Shuffled/Sorted Arrays[" << SIZE << "]" << endl;
    for (int i = 0; i < 100; i++)
    {
        if (i % 2 == 0)
            cout << "#";
    ...
    cout << endl << "Ten Percent Insertion Sort Avg: " << tenPercentInsertionAvg  << " Microseconds" << endl;
    cout << "Ten Percent Selection Sort Avg: " << tenPercentSelectionAvg  << " Microseconds" << endl;
    cout << "Ten Percent Bubble Sort Avg: " << tenPercentBubbleAvg  << " Microseconds" << endl;
    cout << "Ten Percent Quick Sort Avg: " << tenPercentQuickAvg  << " Microseconds" << endl;
    cout << "Ten Percent Merge Sort Avg: " << tenPercentMergeAvg  << " Microseconds" << endl << endl;
